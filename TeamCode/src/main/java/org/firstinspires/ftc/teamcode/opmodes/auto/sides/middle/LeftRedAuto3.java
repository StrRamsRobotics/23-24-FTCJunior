...
public class LeftRedAuto3 extends BaseAuto {
    ...
    public void createPoints() {
        ...
        points.add(new AutoPoint(new Point(5.5 * Game.TS, 4.5 * Game.TS), initActions, false));
...
//        AutoPathHelper.addArmDownMovement(chassis, yellowActions);
        ...
        switch(route) {
            case 0:
                ...
                points.add(new AutoPoint(new Point(5.25 * Game.TS, 4.5 * Game.TS), new ArrayList<>(), false));
                points.add(new AutoPoint(new Point(3.5 * Game.TS, 4.5 * Game.TS), new ArrayList<>(), false));
                points.add(new AutoPoint(new Point(3.5 * Game.TS, 2 * Game.TS), new ArrayList<>(), false));
                ...
                break;
            case 2:
                points.add(new AutoPoint(new Point(4.75 * Game.TS, 4.25 * Game.TS), purpleActions, true));
                points.add(new AutoPoint(new Point(5.25 * Game.TS, 4.5 * Game.TS), new ArrayList<>(), false));
                points.add(new AutoPoint(new Point(3.5 * Game.TS, 4.5 * Game.TS), new ArrayList<>(), false));
                points.add(new AutoPoint(new Point(3.5 * Game.TS, 2 * Game.TS), new ArrayList<>(), false));
                points.add(new AutoPoint(new Point(4.25 * Game.TS, 1.25 * Game.TS), new ArrayList<>(), false));
            ...
            case 1:
            default:
                points.add(new AutoPoint(new Point(4.5 * Game.TS, 4.5 * Game.TS), purpleActions, true));
                points.add(new AutoPoint(new Point(5.25 * Game.TS, 4.5 * Game.TS), new ArrayList<>(), false));
                points.add(new AutoPoint(new Point(3.5 * Game.TS, 5 * Game.TS), new ArrayList<>(), false));
                points.add(new AutoPoint(new Point(3.5 * Game.TS, 2 * Game.TS), new ArrayList<>(), false));
