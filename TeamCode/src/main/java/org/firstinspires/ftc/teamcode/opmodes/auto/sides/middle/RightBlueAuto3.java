    ...
    public void createPoints() {
        ...
        switch(route) {
            case 0:
                ...
                points.add(new AutoPoint(new Point(0.75 * Game.TILE_SIZE, 4.5 * Game.TILE_SIZE), purpleActions, false));
            ...
            default:
                ...
                points.add(new AutoPoint(new Point(1.25 * Game.TILE_SIZE, 4.5 * Game.TILE_SIZE), purpleActions, false));
