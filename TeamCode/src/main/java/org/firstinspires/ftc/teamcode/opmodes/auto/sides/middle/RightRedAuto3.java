...
public class RightRedAuto3 extends BaseAuto {
    ...
    public void createPoints() {
        ...
        points.add(new AutoPoint(new Point(5.5 * Game.TS, 2.5 * Game.TS), initActions, false));
...
//        AutoPathHelper.addArmDownMovement(chassis, yellowActions);
        ...
        switch(route) {
            case 0:
                points.add(new AutoPoint(new Point(4.75 * Game.TS, 2.5 * Game.TS), purpleActions, false));
                points.add(new AutoPoint(new Point(4.5 * Game.TS, 2.75 * Game.TS), new ArrayList<>(), true));
                points.add(new AutoPoint(new Point(4.75 * Game.TS, 2.5 * Game.TS), new ArrayList<>(), false));
                points.add(new AutoPoint(new Point(4.25 * Game.TS, 1.25 * Game.TS), new ArrayList<>(), false));
                points.add(new AutoPoint(new Point(4.25 * Game.TS, 1.2 * Game.TS), yellowActions, false));
                break;
            case 2:
                points.add(new AutoPoint(new Point(4.5 * Game.TS, 2.25 * Game.TS), purpleActions, true));
                points.add(new AutoPoint(new Point(5.25 * Game.TS, 2.5 * Game.TS), new ArrayList<>(), false));
                points.add(new AutoPoint(new Point(4.75 * Game.TS, 1.25 * Game.TS), new ArrayList<>(), false));
                points.add(new AutoPoint(new Point(4.75 * Game.TS, 1.2 * Game.TS), yellowActions, false));
                break;
            case 1:
            default:
                points.add(new AutoPoint(new Point(4.5 * Game.TS, 2.5 * Game.TS), purpleActions, true));
                points.add(new AutoPoint(new Point(4.75 * Game.TS, 2.5 * Game.TS), new ArrayList<>(), false));
                points.add(new AutoPoint(new Point(4.5 * Game.TS, 1.25 * Game.TS), new ArrayList<>(), false));
                points.add(new AutoPoint(new Point(4.5 * Game.TS, 1.2 * Game.TS), yellowActions, false));
                break;
        }
        points.add(new AutoPoint(new Point(5.5 * Game.TS, Game.TS), new ArrayList<>(), false));
