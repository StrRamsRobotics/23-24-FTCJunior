...
//        yellowActions.add(new WaitAction(chassis, Chassis.FLAP_WAIT_TIME));
        ...
        switch(route) {
            case 0:
                ...
                points.add(new AutoPoint(new Point(1.25 * Game.TILE_SIZE, 0.75 * Game.TILE_SIZE), new ArrayList<>(), false));
            ...
            case 2:
                ...
                points.add(new AutoPoint(new Point(0.75 * Game.TILE_SIZE, 2.5 * Game.TILE_SIZE), new ArrayList<>(), false));
                points.add(new AutoPoint(new Point(1.75 * Game.TILE_SIZE, 0.75 * Game.TILE_SIZE), new ArrayList<>(), false));
            ...
            default:
                ...
                points.add(new AutoPoint(new Point(1.5 * Game.TILE_SIZE, 0.75 * Game.TILE_SIZE), new ArrayList<>(), false));
