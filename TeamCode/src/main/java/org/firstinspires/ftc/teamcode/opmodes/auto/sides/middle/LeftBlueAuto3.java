...
//        yellowActions.add(new WaitAction(chassis, Chassis.FLAP_WAIT_TIME));
        ...
        switch(route) {
            case 0:
                points.add(new AutoPoint(new Point(1.25 * Game.TILE_SIZE, 2.25 * Game.TILE_SIZE), purpleActions, false));
                points.add(new AutoPoint(new Point(0.75 * Game.TILE_SIZE, 2.5 * Game.TILE_SIZE), purpleActions, true));
                ...
                break;
            case 2:
                points.add(new AutoPoint(new Point(1.25 * Game.TILE_SIZE, 2.75 * Game.TILE_SIZE), purpleActions, false));
                points.add(new AutoPoint(new Point(0.75 * Game.TILE_SIZE, 2.5 * Game.TILE_SIZE), purpleActions, true));
            ...
            default:
                ...
                points.add(new AutoPoint(new Point(1.25 * Game.TILE_SIZE, 2.5 * Game.TILE_SIZE), purpleActions, true));
